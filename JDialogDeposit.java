 ...
 * @author Novin Pendar
 */
public class JDialogDeposit extends javax.swing.JDialog {

    /**
     * Creates new form JDialogDeposit
     */
    public JDialogDeposit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButtonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOkActionPerformed
        ...
        int status = UserManager.manager.withdrawDeposit(accountNumber, nationalCode, money, TransactionType.deposit);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogDeposit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogDeposit dialog = new JDialogDeposit(new javax.swing.JFrame(), true);
